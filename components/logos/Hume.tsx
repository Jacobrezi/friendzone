...
// export type HumeLogoProps = Omit<ImageProps, "src" | "alt">;
...
export default function HumeLogo({ size = "medium", ...props }: HumeLogoProps) {
  const dimensions = {
    small: { width: 106, height: 25 },
    medium: { width: 212, height: 50 },
    large: { width: 318, height: 75 },
  }[size];

  return (
    <Image src="/app_logo.png" alt="App Logo" {...dimensions} {...props} />
  );
}
